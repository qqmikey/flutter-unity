...
public class Build : MonoBehaviour
{
    ...
    public static void DoBuildAndroid()
    {
        ...
        string flutterPath = Path.GetFullPath(Path.Combine(ProjectPath, "../android"));
        string libsPath = Path.Combine(flutterPath, "app/libs");
        string assetsPath = Path.Combine(flutterPath, "app/src/main/assets");
        string jniLibsPath = Path.Combine(flutterPath, "app/src/main/jniLibs");


		string buildLibs = Path.Combine(buildPath, "libs");
		string buildAssets = Path.Combine(buildPath, "src/main/assets");
		string buildJniLibs = Path.Combine(buildPath, "src/main/jniLibs");
        ...
        if (Directory.Exists(jniLibsPath))
            Directory.Delete(jniLibsPath, true);
        ...
        Copy(buildLibs, libsPath);
        Copy(buildAssets, assetsPath);
        Copy(buildJniLibs, jniLibsPath);
